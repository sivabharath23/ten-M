    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <input
          id={id}
          ref={ref}
          className={`w-full px-3 py-2 bg-white border border-slate-200 rounded-xl outline-none appearance-none transition-all duration-150 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 placeholder-slate-400 text-slate-900 text-[16px] ${error ? 'border-danger-500 focus:border-danger-500 focus:ring-danger-500/20' : ''
            } ${className}`}
          {...props}
        />
