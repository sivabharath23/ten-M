  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-slate-50 font-sans text-slate-850 relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 relative overflow-y-auto min-h-screen lg:min-h-0">
        ...
        {/* Main Form Card */}
        <div className="w-full max-w-md bg-white border border-slate-200/80 shadow-[0_25px_50px_-12px_rgba(15,23,42,0.08)] rounded-[32px] p-8 md:p-10 space-y-8 relative z-10 transition-all duration-300 my-auto">
        ...
        <Footer className="w-full max-w-md mt-6 z-10 lg:hidden" />
      </div>
    </div>
  )
}
